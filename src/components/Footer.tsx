  ...
  return (
    <div className="bg-blue-100 text-blue-900 w-full pt-12 pb-6 px-4">
      <Container className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 gap-10 border-t border-blue-200 lg:grid-cols-5">
          <div id="contact-us" className="lg:col-span-2 scroll-mt-20">
            ...
            <div className="mb-6">
              ...
              <p className="text-blue-800">
                889 P. Paredes St, Don Lorenzo Building, <br />
                Sampaloc, Manila
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-blue-800">
                Unit G - 003, Ground Floor, St. Vincent Gym,<br />
                Brgy. Campo Filipino, Naguilian Road,<br />
                Baguio City
              </p>
            </div>
          ...
          <div>
            ...
            <div className="flex mt-5 space-x-5 text-blue-700">
              ...
              <a href="https://www.facebook.com/people/Hiraya-Pathway-Training-Center/61578678186850/" target="_blank" rel="noopener">
                <span className="sr-only">Facebook</span>
                <Facebook />
              </a>
              <a href="https://www.instagram.com/auxesisreview" target="_blank" rel="noopener">
        ...
        <div className="my-10 text-sm text-center text-blue-700">
